        ...
        <div className="flex mt-40 sm:mt-20  my-4 items-center mx-auto justify-center flex-col">
            <div className="flex items-center">
                <div className="w-auto text-justify mr-10 ml-10 mb-5">
                    ...
                    <span className="italic"> base</span> a projectos de malla para los estudiantes de las carreras de Licenciatura en
                    <span className="font-semibold"> Astronomía</span> y <span className="font-semibold">Física </span>, así como para la carrera de
                    <span className="font-semibold"> Fonoaudiología </span> de la UC (Pontificia Universidad Católica de Chile). La herramienta permite visualizar de manera más
